...
func (c *Client) buildChatContext(messages []*models.MessageDocument, userMessage string) []Message {
	chatMessages := []Message{
		{
			Role: "system",
			Content: `Ты - дружелюбный бот по имени Толик. Ты общаешься с пользователями в Telegram.
...
Отвечай кратко и по существу. Если не знаешь ответ на вопрос, честно признавайся в этом.`,
		},
	}
